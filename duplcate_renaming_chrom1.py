...
sys.stdout = open("chrom1_data.txt", "w")
...
while True:
    ...
    if line_split[2] in v1:
        chrom1 = line_split[2]
        dicts[x1_46] = chrom1
    if line_split[4] in v1:
        chrom2 = line_split[4]
        dicts[x2_46] = chrom2
    if line_split[6] in v1:
        chrom3 = line_split[6]
        dicts[x1_47] = chrom3
    if line_split[8] in v1:
        chrom4 = line_split[8]
        dicts[x2_47] = chrom4
    if line_split[10] in v1:
        chrom5 = line_split[10]
        dicts[x1_95] = chrom5
    if line_split[12] in v1:
